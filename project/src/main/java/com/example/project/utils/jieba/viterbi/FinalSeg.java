package com.example.project.utils.jieba.viterbi;

import com.example.project.utils.jieba.CharacterUtil;
import com.example.project.utils.jieba.Node;
import com.example.project.utils.jieba.Pair;
...
public class FinalSeg {
    ...
    private static final String PROB_EMIT = "/static/prob_emit.txt";
