package com.example.project.utils.keyword;

import com.example.project.utils.jieba.JiebaSegmenter;
...
public class TFIDFAnalyzer {
    ...
    public List<Keyword> analyze(String content, int topN) {
        ...
        if (stopWordsSet == null) {
            ...
            loadStopWords(stopWordsSet, this.getClass().getResourceAsStream("/static/dict.big.txt"));
        }
        if (idfMap == null) {
            idfMap = new HashMap<>();
            loadIDFMap(idfMap, this.getClass().getResourceAsStream("/static/idf_dict.txt"));
        }
